...
This capability is Windows-only. The Linux build has no equivalent; right-clicking inside the rendered view on Linux produces no plugin-defined popup (future-work #3 in `openspec/notes/future-work.md`).
